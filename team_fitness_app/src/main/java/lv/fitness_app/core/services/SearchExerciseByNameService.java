...
@Component
@Transactional
public class SearchExerciseByNameService {
    ...
    @Autowired private SearchExerciseByNameRequestValidator validator;

    public SearchExerciseResponse execute(SearchExerciseByNameRequest request) {
